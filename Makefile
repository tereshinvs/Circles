#############################################################################
# Makefile for building: Circles
# Generated by qmake (3.0) (Qt 5.0.1) on: ?? ??? 22 18:55:49 2013
# Project:  Circles.pro
# Template: app
# Command: /usr/lib/x86_64-linux-gnu/qt5/bin/qmake -o Makefile Circles.pro
#############################################################################
...
CXXFLAGS      = -std=gnu++0x -m64 -pipe -O2 -Wall -W -D_REENTRANT -fPIE $(DEFINES)
...
Makefile: Circles.pro /usr/share/qt5/mkspecs/linux-g++-64/qmake.conf /usr/share/qt5/mkspecs/features/spec_pre.prf \
		/usr/share/qt5/mkspecs/common/shell-unix.conf \
		/usr/share/qt5/mkspecs/common/unix.conf \
		/usr/share/qt5/mkspecs/common/linux.conf \
		/usr/share/qt5/mkspecs/common/gcc-base.conf \
...
dist: 
	@test -d .tmp/Circles1.0.0 || $(MKDIR) .tmp/Circles1.0.0 
	$(COPY_FILE) --parents $(SOURCES) $(DIST) .tmp/Circles1.0.0/ && $(COPY_FILE) --parents Circle.h Point.h RenderArea.h Window.h .tmp/Circles1.0.0/ && $(COPY_FILE) --parents Circle.cpp main.cpp Point.cpp RenderArea.cpp Window.cpp .tmp/Circles1.0.0/ && (cd `dirname .tmp/Circles1.0.0` && $(TAR) Circles1.0.0.tar Circles1.0.0 && $(COMPRESS) Circles1.0.0.tar) && $(MOVE) `dirname .tmp/Circles1.0.0`/Circles1.0.0.tar.gz . && $(DEL_FILE) -r .tmp/Circles1.0.0
...
moc_RenderArea.cpp: /usr/include/qt5/QtWidgets/QWidget \
		...
		Point.h \
		RenderArea.h
	/usr/lib/x86_64-linux-gnu/qt5/bin/moc $(DEFINES) $(INCPATH) RenderArea.h -o moc_RenderArea.cpp

moc_Window.cpp: /usr/include/qt5/QtWidgets/QWidget \
		/usr/include/qt5/QtWidgets/qwidget.h \
		/usr/include/qt5/QtGui/qwindowdefs.h \
		/usr/include/qt5/QtCore/qglobal.h \
		/usr/include/qt5/QtCore/qconfig.h \
